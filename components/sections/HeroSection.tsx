...
const HeroSection: React.FC = () => {
  return (
    <section className="relative -mx-6 sm:-mx-12 lg:-mx-24 px-6 sm:px-12 lg:px-24 pt-16 pb-24 bg-slate-50 border-b border-slate-200 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
        <div className="flex-1 text-center lg:text-left animate-fade-up">
          ...
          <div className="mb-8">
            <p className="text-2xl font-serif text-academic-secondary italic mb-1">
              {PROFILE.title}
            </p>
          ...
          <p className="text-xl text-academic-secondary/80 leading-relaxed mb-10 max-w-2xl mx-auto lg:mx-0 font-light">
            {PROFILE.shortBio}
          </p>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-12">
            ...
            <a 
              ...
              className="px-8 py-4 bg-white border border-slate-200 text-academic-primary rounded-xl font-bold shadow-sm hover:border-academic-primary hover:bg-slate-50 transition-all flex items-center gap-2"
            >
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-2">
            {RESEARCH_INTERESTS.map(interest => (
              <span key={interest} className="text-[11px] font-bold text-academic-muted bg-white px-4 py-2 rounded-lg border border-slate-200 shadow-sm transition-transform hover:scale-105">
                {interest}
              </span>
            ))}
          </div>
